...
Therefore, denoting $g(t):=\left(g_1(t),\ldots,g_N(t)\right)^T$, the unknown vector $z(t):=\left(z_1(t),\ldots,z_N(t)\right)^T$ is obtained solving the following linear system
