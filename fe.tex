...
However, the space $L^2(0,T;U)$ in which one has to minimize $F_\varepsilon$ is a quite big one and it depends on the time variable. This makes the optimization problem computationally expensive. This issue can be circumvented by considering the following problem, defined on the smaller space $E$. Namely, we consider the minimization problem  
%
