...
%	\caption{Convergence of the error.}\label{error}
%\end{figure}
...
\begin{figure}[!h]
\centering
  \pgfplotstableread{res.org}{\datpu}
     \pgfplotsset{
     legend cell align=left,
     legend pos=outer north east,
     legend plot pos=right,
...
%\begin{figure}
%	\centering
%	\includegraphics[scale=0.85]{figure6.eps}	
%	\caption{Convergence properties of the method for controllability of the fractional heat equation.}\label{figure_case1}
%\end{figure}
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[scale=0.85]{figure7.eps}
