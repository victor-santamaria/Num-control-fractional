...
Before giving the proof of Theorems \ref{null_control_thm} and \ref{approx_control_thm}, we recall the definitions of null and approximate controllability.
...
We already mentioned that, to the best of our knowledge, there are no results in the literature on the null-controllability of the fractional heat equation involving the integral operator \eqref{fl}. The existing ones deal with the \textit{spectral} definition of the fractional Laplace operator, which is given as follows.
